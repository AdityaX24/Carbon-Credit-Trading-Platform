...
const TransactionCard = ({addressTo, addressFrom ,timestamp, message, keyword, amount, url}) => {
    ...
    return (
        ...
        sm:min-w-[270px]
        sm:max-w-[300px]
        flex-col p-3 rounded-md bg-container:hover hover:shadow-2xl bg-container
        ">
            <div className="flex flex-col items-center w-full mt-3">
                <div className="w-full mb-6 p-2">
                    ...
                    {message && (
                        <>
                        <br />
                        <p className="test-white test-base">Message: {message} </p>
                        </>
                    )}
                </div>
                <img
                    src={gifUrl || url}
                    alt="gif"
                    className="w-full h-64 2x:h-96 rounded-md shadow-1g object-cover"
                    />  
