...
const commonStyles = "min-h-[70px] sm:px-0 px-2 sm:min-w-[120px] flex justify-center items-center border-[0.5px] border-gray-400 text-sm font-light text-white transition-all duration-300 hover:bg-purple-600 hover:border-yellow-300 hover:text-yellow-300 hover:scale-110 hover:rotate-3 hover:shadow-lg";
...
const Input = ({ placeholder, name, type, value, handleChange }) => (
    <input
        ...
        className="my-2 w-full rounded-sm p-2 outline-none bg-transparent text-white border-none text-sm white-glassmorphism transition-all duration-300 focus:ring-4 focus:ring-purple-500 focus:scale-105 hover:bg-purple-900/30"
    />
);
                    ...
                    <div className="p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmorphism transition-all duration-500 hover:shadow-2xl hover:scale-110 hover:rotate-6">
                        <div className="flex justify-between flex-col w-full h-full">
                            ...
                            <div>
                                ...
                                <p className="text-white font-semibold text-lg mt-1 transition-all duration-300 hover:text-yellow-300 hover:scale-110">
                                    Ethereum
                                </p>
                            </div>
                        </div>
